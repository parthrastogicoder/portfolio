...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 dark:bg-dark-surface text-white dark:text-dark-text py-10 transition-colors duration-300">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-bold">Parth Rastogi</h2>
            <p className="mt-2 text-gray-400 dark:text-dark-light-text">
          ...
          <div className="flex flex-col items-center md:items-end">
            <div className="flex space-x-4 mb-4">
              <a 
                ...
                className="text-gray-400 dark:text-dark-light-text hover:text-white dark:hover:text-dark-primary transition-colors"
                aria-label="GitHub"
              >
                <FaGithub size={24} />
              </a>
            ...
            <p className="text-gray-500 dark:text-dark-light-text text-sm">
